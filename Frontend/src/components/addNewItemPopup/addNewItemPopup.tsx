  ...
  return (
    <>
      <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-neutral-900/60 backdrop-blur-sm">
        <div className="w-[420px] bg-primary-900 border border-primary-800 border-l-[4px] border-l-secondary-500 shadow-2xl max-h-[90vh] overflow-y-auto no-scrollbar">
          ...
          <div className="flex flex-col gap-5 p-6">
            <div className="flex flex-col gap-2">
              ...
              <div className="relative">
                <input
                  ...
                  className="regular w-full bg-[#1A2332] border border-primary-800 p-3 text-white placeholder-primary-400 focus:outline-none focus:border-secondary-500 transition-colors text-sm"
                />
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative">
                <select
                  ...
                  className="regular w-full bg-[#1A2332] border border-primary-800 p-3 text-white focus:outline-none focus:border-secondary-500 transition-colors appearance-none text-sm"
                >
                  <option value="" disabled hidden>ALPHA-01 (COLD)</option>
                  <option value="ALPHA-01 (COLD)">ALPHA-01 (COLD)</option>
                  <option value="BETA-02 (DRY)">BETA-02 (DRY)</option>
                  <option value="GAMMA-03 (HAZMAT)">GAMMA-03 (HAZMAT)</option>
                </select>
            ...
            <div className="flex flex-col gap-2">
              ...
              <textarea
                ...
                className="regular w-full bg-[#1A2332] border border-primary-800 p-3 text-white placeholder-primary-400 focus:outline-none focus:border-secondary-500 transition-colors resize-none h-24 text-sm"
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex gap-3">
                <button className="flex-1 bg-primary-400 text-white py-3 flex items-center justify-center gap-2 border border-primary-400 text-xs tracking-widest font-bold">
                ...
                <button className="flex-1 bg-transparent text-primary-300 py-3 flex items-center justify-center gap-2 border border-primary-800 text-xs tracking-widest hover:border-primary-600 transition-colors font-bold">
            ...
            <button
              className="w-full bg-secondary-500 hover:bg-secondary-600 text-white py-4 mt-2 flex items-center justify-center gap-2 text-sm font-bold uppercase tracking-[0.2em] transition-colors"
              onClick={addNewItem}
            >
